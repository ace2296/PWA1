...
//Method 1 "Basic"
	var fsStudent = {}; //empty object
	fsStudent.age = 22; //setters
	fsStudent.career = 'Web Dev';
	fsStudent.sayHello = function() { //method creation //sayHello is the key
		console.log('Hello!');
	}
...
console.log(fsStudent.age);//dot
console.log(fsStudent['age']);//index
...
// this is integrating multiple data types - object with an array of objects
	...
	var obj1 = {
		...
		address: '123 Sail Street',
		studentCount: 20000,
		students: [
		{name: 'John Smith', GPA: 3.2, classes: ['English','Math']},
		{name: 'Albert Einstein', GPA:4},
		{name: 'James Bond', GPA: 4 }
		]
	};
